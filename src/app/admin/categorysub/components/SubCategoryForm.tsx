...
interface Props {
    initialData?: Partial<SubCategoryFormValues> & { id?: string };
    method?: 'POST' | 'PUT';
}
...
export default function SubCategoryForm({
    ...
    const headingTitle = isEdit ? '編輯子類別' : '新增子類別';
    ...
    const form = useForm<SubCategoryFormValues>({
        ...
        defaultValues: {
            ...
            imageUrl: initialData?.imageUrl ?? undefined, // ✅ 用 undefined
    ...
    const onSubmit: SubmitHandler<SubCategoryFormValues> = (values) => {
        setError(undefined);
        ...
        startTransition(async () => {
            ...
            try {
                ...
                if (isEdit) {
                    ...
                    res = await editSubCategory(id, payload as any);
                } else {
