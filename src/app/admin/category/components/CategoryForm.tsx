// app/(admin)/admin/category/components/CategoryForm.tsx
'use client';
...
export default function CategoryForm({ initialData, method = 'POST' }: Props) {
    ...
    const headingTitle = isEdit ? '編輯大類別' : '新增大類別';
    ...
    // 正規化值
    function normalize(values: CategoryFormValues): CategoryFormValues {
        return {
            ...values,
        ...
        startTransition(async () => {
            ...
            try {
                ...
                if (isEdit) {
                    ...
                    res = await editCategory(id, payload as any);
                } else {
